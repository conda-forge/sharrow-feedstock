...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sharrow-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15494&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sharrow-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sharrow` can be installed with:

```
conda install sharrow
```

It is possible to list all of the versions of `sharrow` available on your platform with:
